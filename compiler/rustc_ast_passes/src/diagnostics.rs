...
#[derive(Diagnostic)]
#[diag("`#[arg_splat]` is not supported on argument index {$splatted_arg_index}")]
...
#[derive(Diagnostic)]
#[diag("multiple `#[arg_splat]`s are not allowed in the same function")]
...
#[derive(Diagnostic)]
#[diag("`...` and `#[arg_splat]` are not allowed in the same function")]
